    ...
    <div class="dashboard-body">
        <div class="row gy-4">
            <div class="col-lg-9">
                    ...
                    <div class="row gy-4">
                        <div class="col-sm-7">
                            <div class="grettings-box__content py-xl-4">
                                <h2 class="text-white mb-0 font-bold text-2xl">Halo, {{ $user->name }}! </h2>
                                <p class="text-lg fw-light mt-32 text-white" id="motivational-quotes">
                                </p>
                            </div>
                        </div>
                ...
                {{-- CHECK AUTH USER HAS KELAS OR NOT. IF USER HAS KELAS, SHOW THE CONTENT --}}
                    ...
                    <div class="card mt-24 overflow-hidden">
                        <div class="card-header">
                            <div class="mb-0 flex-between flex-wrap gap-8">
                                <h4 class="mb-0">Tugas dan Pekerjaan Rumah</h4>
                                <a href="student-courses.html"
                                    class="text-13 fw-medium text-main-600 hover-text-decoration-underline">Lihat Semua</a>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="flex-align gap-8 mt-12">
                                                <div class="progress w-100px  bg-main-100 rounded-pill h-4"
                                                    ...
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-bar bg-main-600 rounded-pill" style="width: 50%">
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="flex-align gap-8 mt-12">
                                                <div class="progress w-100px  bg-main-100 rounded-pill h-4"
                                                    ...
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-bar bg-main-600 rounded-pill" style="width: 72%">
                                                    </div>
                                                </div>
