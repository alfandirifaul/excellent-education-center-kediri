                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 order-last order-lg-first">
                        <div class="slider__img__box mb-50 pr-30">
                            <img class="img-one mt-55 pr-70" src="{{ asset('img/slider/01.png') }}"
                                 alt="Slider Image 1">
                            <img class="slide-shape img-two" src="{{ asset('img/slider/02.png') }}"
                                 alt="Slider Image 2">
                            <img class="slide-shape img-three" src="{{ asset('img/slider/03.png') }}"
                                 alt="Slider Image 3">
                            ...
                            <img class="slide-shape img-seven wow fadeInRight animated" data-delay="1.5s"
                                 src="{{ asset('img/icon/dot-plan-1.svg') }}" alt="Dot Plan">
                            <img class="slide-shape img-eight" src="{{ asset('img/slider/earth-bg.svg') }}"
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="slider__content pt-15">
                            ...
                            <h5 class="mb-35 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                Berbagai jenis materi pembelajaran tersedia di Excellent Education Center, yang telah
                                dirancang dan
                    ...
                    <div class="col-lg-10">
                        <div class="slider__content slider__content__03 text-center pt-120 pr-50 pl-50">
                            ...
                            <h5 class="mb-100 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                Temukan pengalaman belajar yang berkualitas dengan materi pembelajaran yang terstruktur
                                dan interaktif, didukung oleh para pengajar berpengalaman untuk membantu Anda mencapai
                                potensi terbaik.
                            </h5>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="slider-img-area">
                            <div class="slider-img-box-three"
                                 style="background-image: url({{ asset('img/slider/04.jpg') }});">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-title text-center mb-55">
                            <h5 class="bottom-line mb-25">Mari Bergabung</h5>
                ...
                <div class="row mb-85">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="what-box text-center mb-35 wow fadeInUp2 animated" data-wow-delay='.3s'>
                            ...
                            <p>
                                Dapatkan akses ke berbagai kursus berkualitas dan tingkatkan keterampilan Anda bersama
                                kami. Daftar sekarang dan mulai perjalanan belajar Anda! </p>
                            <a href="{{ route('login') }}" class="theme_btn border_btn active">Gabung Sekarang</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="chose-img-wrapper mb-50 pos-rel">
                                ...
                                <div class="feature tag_01"><span><img
                                            src={{ asset("img/icon/shield-check.svg") }} alt=""></span> Aman &
                                    Terpercaya
                                </div>
                                <div class="feature tag_02"><span><img
                                            src={{ asset("img/icon/catalog.svg") }} alt=""></span> 120+ Kelas
                                </div>
                                <div class="feature tag_03"><span><i class="fas fa-check"></i></span> Pembelajaran
                                    Berkualitas
                                </div>
                                {{-- <div class="video-wrapper">
                                    <a href="https://www.youtube.com/watch?v=7omGYwdcS04" class="popup-video"><i class="fas fa-play"></i></a>
                                ...
                                <div class="img-bg pos-rel">
                                    <img class="chose_05 pl-70 pl-lg-0 pl-md-0 pl-xs-0"
                                         src={{ asset("img/chose/05.png") }} alt="Chose-img">
                                </div>
                        ...
                        <div class="col-xl-5 col-lg-5">
                            <div class="chose-wrapper pl-25 pl-lg-0 pl-md-0 pl-xs-0">
                                <div class="section-title mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                    ...
                                    <p>
                                        Excellent Education Center menyediakan solusi pendidikan terpadu dengan materi
                                        berkualitas, tenaga pengajar profesional, dan fleksibilitas
